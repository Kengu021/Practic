...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Сен 19 2020 г., 10:00
...
--
-- Дамп данных таблицы `user acounts`
--

INSERT INTO `user acounts` (`user_id`, `name`, `password`, `email`) VALUES
(1, '1', 'dab9befb2d87902e5254797660cd5539', '1@mail.ru');
...
--
ALTER TABLE `user rights`
  MODIFY `id_rights` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
COMMIT;
